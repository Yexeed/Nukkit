...
public class EffectCommand extends Command {
    public EffectCommand(String name) {
        ...
        this.commandParameters.put("default", new CommandParameter[]{
                ...
                new CommandParameter("effect", CommandParamType.RAWTEXT, false), //Do not use Enum here because of buggy behavior
                new CommandParameter("seconds", CommandParamType.INT, true),
                new CommandParameter("amplifier", true),
                new CommandParameter("hideParticle", CommandParamType.RAWTEXT, true)
        });
