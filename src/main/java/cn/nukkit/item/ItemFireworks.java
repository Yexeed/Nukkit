...
public class ItemFireworks extends Item {
    ...
    public boolean onActivate(Level level, Player player, Block block, Block target, BlockFace face, double fx, double fy, double fz) {
        if (block.canPassThrough()) {
            /*clearExplosions();
            addExplosion(new FireworkExplosion().trail(true).flicker(true).type(ExplosionType.LARGE_BALL)
                    .addColor(DyeColor.RED)
                    .addColor(DyeColor.ORANGE)
                    .addFade(DyeColor.BLUE)
    ...
    public static class FireworkExplosion {
        ...
        public FireworkExplosion flicker(boolean flicker) {
            this.flicker = flicker;
            return this;
        }

        public FireworkExplosion trail(boolean trail) {
            this.trail = trail;
            return this;
        }
